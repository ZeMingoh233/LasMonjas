            ...
            foreach (PlayerControl player in PlayerControl.AllPlayerControls) {
                foreach (RoleInfo roleInfo in RoleInfo.allRoleInfos) {
                    ...
                    if (/* Special roles */ roleInfo.roleId == RoleId.Lover || roleInfo.roleId == RoleId.Kid || (roleInfo == RoleInfo.vigilantMira && PlayerControl.GameOptions.MapId != 1) || (roleInfo == RoleInfo.vigilant && PlayerControl.GameOptions.MapId == 1)
                        ...
                        /* King of the hill*/ || roleInfo.roleId == RoleId.GreenKing || roleInfo.roleId == RoleId.YellowKing || roleInfo.roleId == RoleId.GreenPlayer01 || roleInfo.roleId == RoleId.GreenPlayer02 || roleInfo.roleId == RoleId.GreenPlayer03 || roleInfo.roleId == RoleId.GreenPlayer04 || roleInfo.roleId == RoleId.GreenPlayer05 || roleInfo.roleId == RoleId.GreenPlayer06 || roleInfo.roleId == RoleId.YellowPlayer01 || roleInfo.roleId == RoleId.YellowPlayer02 || roleInfo.roleId == RoleId.YellowPlayer03 || roleInfo.roleId == RoleId.YellowPlayer04 || roleInfo.roleId == RoleId.YellowPlayer05 || roleInfo.roleId == RoleId.YellowPlayer06 || roleInfo.roleId == RoleId.YellowPlayer07)
                    continue;
