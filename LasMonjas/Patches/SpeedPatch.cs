...
namespace LasMonjas.Patches
{
    ...
    public static class SpeedPatch
    {
        ...
        public static void PostfixPhysics(PlayerPhysics __instance)
        {
            ...
            else if (__instance.AmOwner && GameData.Instance && __instance.myPlayer.CanMove && PlayerControl.LocalPlayer == Modifiers.flash)
                __instance.body.velocity *= 1.10f;
            else if (__instance.AmOwner && GameData.Instance && __instance.myPlayer.CanMove && PlayerControl.LocalPlayer == Modifiers.bigchungus)
        ...
        public static void PostfixNetwork(CustomNetworkTransform __instance) {
            if (__instance.AmOwner && __instance.interpolateMovement != 0.0f && PlayerControl.LocalPlayer == Janitor.janitor && Janitor.dragginBody)
                __instance.body.velocity *= 0.80f; 
            else if (__instance.AmOwner && __instance.interpolateMovement != 0.0f && PlayerControl.LocalPlayer == Modifiers.flash)
                __instance.body.velocity *= 1.10f;
            else if (__instance.AmOwner && __instance.interpolateMovement != 0.0f && PlayerControl.LocalPlayer == Modifiers.bigchungus)
                __instance.body.velocity *= 0.90f;
        }
    }
}