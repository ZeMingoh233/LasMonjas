...
namespace LasMonjas
{
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            // Modifiers
            activateModifiers = CustomOption.Create(10, cs(Modifiers.color, "Modifiers"), "setting", rates, null, true);
            activateRoles = CustomOption.Create(11, cs(Modifiers.color, "Roles") + ": Activate mod roles and block vanilla ones", "setting", true, activateModifiers);
            randomRoles = CustomOption.Create(12, cs(Modifiers.color, "Roles") + ": Role Assignment", "setting", new string[] { "Random", "List Order" }, activateModifiers);
            ...
            thiefModecaptureThiefTime = CustomOption.Create(47, cs(Coward.color, "Police and Thiefs") + ": Time to Arrest", "gamemode", 3f, 3f, 5f, 1f, policeAndThiefMode);
            ...
            kingOfTheHillMode = CustomOption.Create(60, cs(Squire.color, "King of the Hill"), "gamemode", rates, null, true);
            ...
            // Hot Potato
            hotPotatoMode = CustomOption.Create(70, cs(Medusa.color, "Hot Potato"), "gamemode", rates, null, true);
            ...
            // ZombieLaboratory
            zombieLaboratoryMode = CustomOption.Create(80, cs(Hunter.color, "Zombie Laboratory"), "gamemode", rates, null, true);
            ...
            demonKillDelay = CustomOption.Create(132, cs(Demon.color, "Demon") + ": Delay Time", "impostor", 10f, 10f, 15f, 1f, demonSpawnRate);
